...
/*  69:    */     
/*  70:118 */     Object packet = packetClass.getConstructor(new Class[] { String.class, Float.TYPE, Float.TYPE, Float.TYPE, Float.TYPE, Float.TYPE, Float.TYPE, Float.TYPE, Integer.TYPE }).newInstance(new Object[] { effect.name, Float.valueOf((float)location.getX()), 
...
/*  83:    */       {
/*  84:129 */         m.invoke(playerConnection, new Object[] { packet });
/*  85:130 */         return;
/*  86:    */       }
/*  87:    */     }
/*  88:    */   }
